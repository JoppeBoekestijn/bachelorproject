...
#train_dir ='/data/tensorflow/dataset_tropic/'
#test_dir ='/data/tensorflow/dataset_tropic/'
...
def train_data():
    ...
    train_dir = '/data/tensorflow/dataset_tropic/'+ dataset_name+'/train'
    test_dir = '/data/tensorflow/dataset_tropic/'+ dataset_name+'/test'
    ...
    print("working on {0}% training: {1}".format(train_size, len(x_train)))
    
    # Input image dimensions.
    if K.image_data_format() =='channels_first':
        input_shape = (num_channels, imw, imw)
    else:
        input_shape = (imw, imw, num_channels) 
    ...
    model_name = 'tropic10_%s_ts%s_imw%s_%s_model.{epoch:03d}.h5' % (dataset_name,train_size,imw,model_type)
    ...
    #print to log file
    with open('_all_1vsall.log','a') as logfile:
        logfile.write('%s, trainsize: %s, imw: %s, accuracy: %f' %(dataset_name,train_size, imw,scores[1]*100))
        logfile.write("\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name',   default ='exp1', help='dataset name')
    parser.add_argument('--imw',            default=128, type=int, help='Image size')
